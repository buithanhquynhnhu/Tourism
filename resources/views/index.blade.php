...
<div class="container" >
    <div class="row" >
      ...
      <div
        class="card col-sm-12" align="center">
        @if ($data)
        @foreach ($data as $i )
            <div class="card-body">
                <img src="{{$i->img}}" style="width: 850px" /><a href="{{route('chitietsanpham',$i->id)}}"></a><br>
                <span class="card-title" >
                    <a href="{{$i->slug}}"><a href="{{route('chitietsanpham',$i->id)}}">{!!$i->name!!}</a>
                </span>
                <p ><i class="fas fa-chair">Số chỗ:{{$i->socho}}</i></p>
                <p style="color: red;" ><i class="fas fa-money-check-alt">Giá:{{number_format($i->gia)}}</i></p>
          <div class="d-flex justify-content-center">
            <button
              style="width: 200px; border-color: rgb(55, 168, 2); border-radius: 10px; color: green;"
            >
            <i class="fas fa-shopping-cart">Thêm vào chỗ hàng</i>
            </button>
          </div>
        </div>
        @endforeach
